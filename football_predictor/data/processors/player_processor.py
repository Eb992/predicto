...
class PlayerProcessor:
    ...
    def process_player_stats(self, stats: pd.DataFrame) -> pd.DataFrame:
        ...
        numeric_cols = ['goals', 'assists', 'minutes', 'shots', 'shots_on_target',
                       'xg', 'xa', 'fouls_committed', 'fouls_drawn', 'yellow_cards',
                       'red_cards', 'passes', 'pass_accuracy']
    ...
    def aggregate_team_stats(self, player_stats: pd.DataFrame, 
                            team:  str, season: int = None) -> Dict[str, float]:
    ...
    def get_key_players(self, player_stats: pd. DataFrame, 
                        team: str, n:  int = 5) -> List[Dict]: 
