...
class BetTracker:
    ...
    def update_bet_result(self, bet_id: str, status: str, result: str, bankroll_after: float):
    ...
    def get_performance_summary(
        self, start_date: str = None, end_date: str = None, market: str = None
    ) -> Dict:
    ...
    def get_performance_by_market(self) -> Dict[str, Dict]:
        ...
        return {market: self.get_performance_summary(market=market) for market in markets}
