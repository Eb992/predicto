...
class FormFeatureExtractor: 
    ...
    def get_form_features(self, team:  str, before_date: datetime,
    ...
    def get_scoring_form(self, team: str, before_date:  datetime,
        ...
        return {
            ...
            'conceding_trend': np.mean(goals_conceded_list[: mid]) - np.mean(goals_conceded_list[mid:]) if mid > 0 else 0,
