...
class TeamFeatureExtractor:
    ...
    def get_team_stats(self, team:  str, before_date: datetime, 
                       n_games: int = 10, venue: Optional[str] = None) -> Dict[str, float]:
        """
    ...
    def get_scoring_patterns(self, team:  str, before_date: datetime,
                             n_games: int = 20) -> Dict[str, float]:
    ...
    def get_home_away_splits(self, team:  str, before_date: datetime,
                             n_games:  int = 10) -> Dict[str, float]:
