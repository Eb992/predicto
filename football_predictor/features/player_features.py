...
class PlayerFeatureExtractor:
    ...
    def get_key_player_availability(self, team:  str, 
                                    injured_players: List[str] = None,
                                    suspended_players: List[str] = None) -> Dict[str, float]:
    ...
    def get_player_prop_features(self, player_name: str, team: str,
                                  prop_type: str = 'shots_on_target') -> Dict[str, float]:
